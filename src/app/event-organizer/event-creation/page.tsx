              ...
              <Form className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Calendar
                    ...
                    numberOfMonths={1}
                    className="rounded-lg border w-69"
                    disabled={(d) => {
                  ...
                  />
                  <div className="flex justify-center items-center text-sm text-gray-600 mt-2 border border-neutral-200 rounded-lg h-10 px-4 w-69">
                  ...
                  <div className="mt-4 border-t pt-4 flex flex-col gap-2 w-69">

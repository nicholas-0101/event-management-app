  ...
  useEffect(() => {
    ...
    const fetchEvent = async () => {
      try {
        ...
        setEvent({ id: data.id, ...data, tickets });
      } catch (err: any) {
  ...
  if (!event)
    return (
      <p className="pt-4 text-neutral-600 text-center text-lg font-medium flex flex-col gap-2 justify-center items-center">
        <SearchX color="#09431C" size={60} /> Event Not Found
      </p>
    );
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-10">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        {/* Right: Tickets (no purchase actions in organizer view) */}
        <div className="lg:col-span-1 flex flex-col">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-3">
              Organizer view: purchasing disabled.
            </p>
          </div>
        </div>
      </div>
